...
var crel__default = /*#__PURE__*/_interopDefaultLegacy(crel);
...
MenuItem.prototype.render = function render (view) {
  ...
  var dom = spec.render ? spec.render(view)
      ...
      : spec.label ? crel__default['default']("div", null, translate(view, spec.label))
      : null;
...
Dropdown.prototype.render = function render (view) {
  ...
  var label = crel__default['default']("div", {class: prefix$1 + "-dropdown " + (this.options.class || ""),
                           style: this.options.css},
                   translate(view, this.options.label));
  if (this.options.title) { label.setAttribute("title", translate(view, this.options.title)); }
  var wrap = crel__default['default']("div", {class: prefix$1 + "-dropdown-wrap"}, label);
...
Dropdown.prototype.expand = function expand (dom, items) {
  var menuDOM = crel__default['default']("div", {class: prefix$1 + "-dropdown-menu " + (this.options.class || "")}, [crel__default['default']("div", {class: prefix$1 + "-dropdown-menu-head"})].concat(items));
...
function renderDropdownItems(items, view) {
  ...
  for (var i = 0; i < items.length; i++) {
    ...
    rendered.push(crel__default['default']("div", {class: prefix$1 + "-dropdown-item"}, dom));
    updates.push(update);
  }
...
DropdownSubmenu.prototype.render = function render (view) {
  ...
  var label = crel__default['default']("div", {class: prefix$1 + "-submenu-label"}, translate(view, this.options.label));
  var wrap = crel__default['default']("div", {class: prefix$1 + "-submenu-wrap"}, label,
                 crel__default['default']("div", {class: prefix$1 + "-submenu"}, items.dom));
...
function renderGrouped(view, content) {
  ...
  for (var i = 0; i < content.length; i++) {
    ...
    for (var j = 0; j < items.length; j++) {
      ...
      var span = crel__default['default']("span", {class: prefix$1 + "item"}, dom);
...
function separator() {
  return crel__default['default']("span", {class: prefix$1 + "separator"})
}
...
var MenuBarView = function MenuBarView(editorView, options) {
  ...
  this.wrapper = crel__default['default']("div", {class: prefix + "-wrapper"});
  this.menu = this.wrapper.appendChild(crel__default['default']("div", {class: prefix}));
...
MenuBarView.prototype.updateFloat = function updateFloat (scrollAncestor) {
  ...
  if (this.floating) {
    ...
    if (editorRect.top < top && editorRect.bottom >= this.menu.offsetHeight + 10) {
      ...
      this.spacer = crel__default['default']("div", {class: prefix + "-spacer", style: ("height: " + (menuRect.height) + "px")});
